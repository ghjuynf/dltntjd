...
function First_Nogada(a, b, c){
  ...
  function Second_Nogada(a, b, c){
    switch(First_Nogada(a, b, c)){
      case "국어":
        return '2,3반 = 안현아선생님, 6,8,9반 = 강현주선생님';
      case "수학":
        return '2,3반 = 김병재선생님, 6,8,9반 = 이준서선생님';
      case "과학":
        return '2,3반 = 김시용선생님, 6,8,9반 = 김향숙선생님';
      case "사회":
        return '2,3반 = 서진화선생님, 6,8,9반 = 곽지영선생님';
      case "역사":
        return '2,3,6,8,9반 = 송혜경선생님';
      case "영어":
        return '2,3반 = 강지현선생님, 6,8,9반 = 윤혜진선생님';
      case "음악":
        return '2,3,6,8,9반 = 권민수선생님';
      case "자율":
        return 'free';
      case "미술":
        return '2,3반 = 김승미선생님, 6,8,9반 = 민솔선생님';
      case "정보":
        return '2,3,6,8,9반 = 김혜란선생님';
      case "중어":
        return '2,3,6,8,9반 = 고은정선생님';
      case "체육":
        return '2,3반 = 진현호선생님, 6반 = 이상윤선생님, 8,9반 = 홍영상선생님';
      default:
        return "invalid";
    }
  }
